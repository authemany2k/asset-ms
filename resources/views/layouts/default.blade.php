...
<html>
  ...
  <body class="sidebar-mini skin-blue {{ (session('menu_state')!='open') ? 'sidebar-mini fixed sidebar-mini' : ''  }}">
    <div class="wrapper">
      ...
      <footer class="main-footer hidden-print">
        <div class="pull-right hidden-xs">
            <b>Version</b> {{ config('version.app_version') }}  1.0)
        ...
        <a target="_blank" href="http://www.authemanict.com" rel="noopener">IT Assets Managemenet System</a> Developed by AUTHEMAN ICT LTD
